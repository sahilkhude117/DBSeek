...
export const explainationsSchema = z.array(explainationSchema);

export type QueryExplanation = z.infer<typeof explainationSchema>;
...
export const configSchema = z
    .object({
        ...
        multipleLines: z.boolean().describe("For line chart only: whether the chart is comparing groups of data.").optional(),
        ...
        lineCategories: z.array(z.string()).describe("For line charts only: Categories used to compare diffrent lines or data series. Each category represents a distinct line in the chart.").optional(),
        colors: z
            .record(
